...
%TODO: VER SE FAZ SENTIDO DEIXAR ISSO
% Empregando o uso do \textit{HoldOut}, o modelo é avaliado com 9,4\% do conjunto total de imagens, para teste, revelando uma perda de 60,12\%, juntamente com uma acurácia de 68,75\%, conforme definido na Subseção \ref{treinamento}.
...
\begin{minipage}{0.45\textwidth}
  ...
  \vspace{-0.4cm}
  \includegraphics[width=\linewidth]{figuras/acurácia.png}
  \captionsetup{justification=centering}
  \vspace{-0.2cm}
  \\\textbf{\footnotesize Fonte: Elaborado pelos autores}
  \label{fig:acc}
...
% A partir da análise da matriz de confusão, foram geradas as métricas de precisão e sensibilidade, citadas na Subseção \ref{treinamento}. O modelo atingiu uma precisão de 57,14\% para classificar casos de pacientes com câncer, assim como uma sensibilidade de 60,27\% para o mesmo caso. Para uma avaliação geral do desempenho, a acurácia foi calculada, resultando em 57,53\%.
