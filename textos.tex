...
% Em contrapartida, a sensibilidade revela a proporção de casos positivos identificados corretamente. Adicionalmente, a pontuação F1 oferece um equilíbrio entre precisão e sensibilidade. 
...
\begin{tabular}{|c|c|c|c|c|} 
  \hline
    Classificação & Precisão & Sensibilidade  \\ % & Pontuação F1
  \hline
    Com câncer & 0.52 & 0.44 \\ % & 0.48
  \hline
    Sem câncer & 0.51 & 0.59 \\ % & 0.55
  \hline
\end{tabular}
	\vspace{0.2cm}
     \\\textbf{\footnotesize Fonte: Elaborado pelos autores}
...
Finalmente, obteve-se o resultado do cálculo da acurácia, usando dados da matriz de confusão. Dado que a acurácia é resultada pelo número total de acertos, pelo número total de predições, a acurácia do modelo nesse sentido resultou em 52\%.
